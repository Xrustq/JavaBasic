...
public class Calculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the expression by separating each character with a space : ");
...
//        printType();
    ...
    protected void convertToRPN(String tokens) {

        StringTokenizer tokenizer = new StringTokenizer(tokens);
        // Урезанный алгоритм "сортировочная станция" Э.Дейкстры
        while (tokenizer.hasMoreTokens()) {                  // пока не все токены обработаны
            String token = tokenizer.nextToken();           //  1. прочитать токен
